    ...
    <section className="common-padding">
      <div className="screen-max-width">
        ...
        <div className="mt-10 md:mt-20 mb-14">
          ...
          <p className="text-gray font-semibold mt-3 flex justify-center">Honkai: Star Rail</p>

          <div className="hiw-text-container mt-4">
            ...
            <div className="flex-1 flex flex-col g_fadeIn justify-center">
